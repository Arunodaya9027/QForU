                ...
                if question is None:
                    ...
                    if (description.count('<strong>Input:</strong>') == 0):
                        ...
                        for i in range(total_pre):
                            ...
                            example = {"QuestionID": QID, "ExNo": i+1, "Input": input.strip().strip("\n").strip("\t").strip("\r"),
    ...
    def to_sql(self, db_config, example):
        ...
        try:
            if connection.is_connected():
                ...
                insert_query = "INSERT INTO question_master_detail_coding(Question_Id, ExampleNo, Input, ExpectedOutput, Explanation) VALUES(%s, %s, %s, %s, %s);"
